...
const BLOG_PREVIEW_ARTICLES: BlogPreviewArticle[] = [
  {
    id: "systems-thinking",
    title: "Systems Thinking for Product Engineers",
    publishHint: "Draft in progress",
    excerpt:
      "Notes on turning product constraints into reliable engineering loops.",
  },
  {
    id: "canvas-ui",
    title: "Building Playful Canvas Interfaces",
    publishHint: "Coming soon",
    excerpt:
      "A walkthrough on balancing interaction performance with expressive UI.",
  },
  {
    id: "design-engineering",
    title: "Design, Code, and the Space In Between",
    publishHint: "Coming soon",
    excerpt:
      "How product intuition and implementation detail can reinforce each other.",
  },
];
          ...
          <div className="px-4 py-4 sm:px-7 sm:py-6 text-[var(--retro-accent-blue-text)] font-[Inconsolata]">
            <section className="rounded-sm border border-[var(--retro-border-soft)] bg-[var(--retro-window-alt)] p-4 sm:p-5">
              ...
              <p className="mt-3 text-sm sm:text-[15px] leading-6 text-[var(--retro-text-muted)]">
                Layout is ready. Final article content will be added later.
              </p>
            </section>
